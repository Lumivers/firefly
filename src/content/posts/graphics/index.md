...
| 章节 | 主题 | 面试权重 |
|------|------|---------|
| [**Ch1**](./01_rendering_pipeline/) | 渲染管线与 MVP 变换 | ★★★★★ |
| [**Ch2**](./02_texture_and_sampling/) | 纹理与采样 | ★★★★☆ |
| [**Ch3**](./03_lighting_models/) | 光照模型 | ★★★★★ |
| [**Ch4**](./04_shadow_techniques/) | 阴影技术 | ★★★★☆ |
| [**Ch5**](./05_pbr_deep_dive/) | PBR 深入 | ★★★★★ |
| [**Ch6**](./06_forward_deferred/) | 前向与延迟渲染 | ★★★★★ |
| [**Ch7**](./07_postprocess_gi/) | 后处理与实时 GI | ★★★☆☆ |
| [**Ch8**](./08_mobile_rendering/) | 移动端渲染与调试 | ★★★★★ |
...
#### [第六章 前向渲染与延迟渲染](./06_forward_deferred/)
...
#### [第七章 后处理与实时 GI 入门](./07_postprocess_gi/)
...
#### [第八章 移动端渲染架构与调试](./08_mobile_rendering/)
