---
title: Lumi-Hub 开发日志：2026年3月10日
published: 2026-03-10
description: '今日完成了 MCP（Model Context Protocol）的完整闭环开发，涵盖从零搭建后端 MCP 管理器、接入 AstrBot 主流程、实现安全的 Human-in-the-Loop 工具调用网关，到实现前端可视化配置界面的全链路。
image: 'api'
tags: [Lumi-hub, 开发笔记]
category: 开发笔记
draft: false
